...
export type FormFieldElement = HTMLDivElement & {
    validate?: () => FieldState;
    setFeedback?: (message: string) => void;
    setError?: (code: string, fallbackMessage?: string) => void;
};
...
export type ValidatorKey = "name" | "email" | "current-password" | "new-password" | "checkbox";
...
export type CheckboxCode = "" | "REQUIRED";